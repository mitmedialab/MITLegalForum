...
**Use this [Google Form](https://goo.gl/forms/unO3Do94Mi04bItH2) (also [embedded below](http://mitlegalforum.org/#invitation-to-attend-and-participate)) to participate as an in-person or online attendee** in the MIT Legal Forum on AI & Blockchain at the MIT Media Lab October 30-31, 2017.  Attendees may join and contribute to MIT Legal Forum breakout groups, workshops, learning sessions and other activities.  To watch public live streams from the MIT Legal Forum, register on  [EventBrite (below)](https://mit-law-ai-blockchain.eventbrite.com) and you will receive general announcements and updates, including links to public live streams with corresponding #hashtags.  
